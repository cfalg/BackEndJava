...
public interface JugadorService {
	...
	//Borra un jugador
	void deleteJugador(String id_jugador);
	
	//retorna un jugador a partir del seu id
	Jugador getJugador(String id_jugador);
