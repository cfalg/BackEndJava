...
//	@Override
//	public long deletePartides(Integer iD_jugador) {
...
//		
//		
//		return partidaRepository.deletePartidaByFkJugador(iD_jugador);
//	}

	@Override
	public String deletePartides(Integer iD_jugador) {
		Optional<Jugador> j = jugadorRepository.findById(iD_jugador);
//		if (j != null) {
//			return partidaRepository.deletePartidaByFkJugador(j);
//		} else {
...
//		}
	...
	@Override
	public List<Partida> getAllPartides(Integer iD_jugador) {
	...
	public String getRanking() {
		...
		System.out.println("El ranking mig de tots els jugadors del sistema es " + jugadorRepository.getAverageRati());

		return "El ranking mig de tots els jugadors del sistema es " + jugadorRepository.getAverageRati();
	...
	@Override
	public void deleteJugador(int id_jugador) {
