...
public class PartidaController {
	...
	public ResponseEntity<?> tirarDaus(@PathVariable("id") int id_Jugador) {
	...
	public ResponseEntity<?> delete(@PathVariable(name = "ID") Integer iD_jugador) {
	...
	public ResponseEntity<?> getAllPartides(@PathVariable(name = "ID") Integer iD_jugador) {
