...
public class SwaggerConfig {
	...
	//https://openwebinars.net/blog/configura-swagger-para-documentar-tu-api-rest-con-spring-boot/
	
	@Bean
	public Docket apiDocket() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.itacademy.s0402_simpleHttpService.Controllers"))
